...
const adminUserController = {
  ...
  deleteUser: async (req, res) => {
    try {
      ...
      res
        ...
        .json({
          message:
            "Erreur serveur - Erreur lors de la suppression de l'utilisateur",
        });
    }
  },
  ...
  banUser: async (req, res) => {
    try {
      ...
      res
        ...
        .json({
          message:
            "Erreur serveur - Erreur lors du bannissement de l'utilisateur",
        });
    }
  },
  ...
  unBanUser: async (req, res) => {
    try {
      ...
      res
        ...
        .json({
          message:
            "Erreur serveur - Erreur lors du débannissement de l'utilisateur",
        });
    }
  },
  ...
  userToAdmin: async (req, res) => {
    try {
      ...
      res
        .status(200)
        .json({ message: "Utilisateur promu administrateur avec succès" });
    } catch (error) {
      console.log(error);
      res
        .status(500)
        .json({
          message:
            "Erreur serveur - Erreur lors de la promotion de l'utilisateur en administrateur",
        });
    }
  },
  ...
  adminToUser: async (req, res) => {
    try {
      ...
      res
        ...
        .json({
          message:
            "Erreur serveur - Erreur lors de la rétrogradation de l'utilisateur",
        });
    }
  },
};
